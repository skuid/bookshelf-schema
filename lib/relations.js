 ...
 *
 */
var BelongsTo, BelongsToMany, Field, Fulfilled, HasMany, HasOne, IntField, MorphMany, MorphOne, MorphTo, Rejected, Relation, StringField, camelize, lowerFirst, pluralize, promiseFinally, pushField, ref, ref1, ref2, singularize, underscore, upperFirst, values,
  slice = [].slice,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

ref = require('inflection'), pluralize = ref.pluralize, singularize = ref.singularize, camelize = ref.camelize, underscore = ref.underscore;
...
BelongsTo = (function(superClass) {
  ...
  BelongsTo.prototype.contributeToSchema = function(schema) {
    ...
    if (this.options.name != null) {
      if (foreignKey == null) {
        foreignKey = (underscore(this.options.name)) + "_id";
      }
    }
    if (foreignKey == null) {
      foreignKey = (underscore(this._relatedModelName())) + "_id";
    }
    return pushField(schema, foreignKey, Field(foreignKey));
  };
