 ...
 *
 */
var BooleanField, DateField, DateTimeField, EmailField, EncryptedString, EncryptedStringField, Field, FloatField, IntField, JSONField, NumberField, StringField, UUIDField, utils,
...
EncryptedStringField = (function(superClass) {
  ...
  EncryptedStringField.prototype.parse = function(attrs, options) {
    if ((attrs != null ? attrs[this.column] : void 0) == null) {
      return attrs;
    }
    if (attrs != null) {
      attrs[this.column] = new EncryptedString(attrs != null ? attrs[this.column] : void 0, null, this.options);
    }
    return attrs;
  };
  ...
  EncryptedStringField.prototype.format = function(attrs, options) {
    var me;
    me = attrs != null ? attrs[this.column] : void 0;
    if (me == null) {
      return attrs;
    }
  ...
  EncryptedStringField.prototype._onSaving = function(instance, attrs, options) {
    var me;
    me = (attrs != null ? attrs[this.column] : void 0) || instance.attributes[this.column];
    if (me == null) {
      return;
    }
    ...
    if (!(me instanceof EncryptedString)) {
      me = attrs != null ? attrs[this.column] = instance.attributes[this.column] = new EncryptedString(null, me, this.options) : void 0;
    }
    return me.encrypt();
  };
...
DateTimeField = (function(superClass) {
  ...
  DateTimeField.prototype.format = function(attrs) {
    if (((attrs != null ? attrs[this.column] : void 0) != null) && !((attrs != null ? attrs[this.column] : void 0) instanceof Date)) {
      return attrs[this.column] = new Date(attrs[this.column]);
    }
  };
